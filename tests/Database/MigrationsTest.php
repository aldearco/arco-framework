...
class MigrationsTest extends TestCase {
    ...
    protected $expectedDirectory = __DIR__ . "/expected";
    ...
    public function migrationNames() {
        return [
            [
                ...
                "$this->expectedDirectory/create_products_table.php"
            ],
            [
                "add_category_to_products_table",
                "$this->expectedDirectory/add_category_to_products_table.php"
            ],
            [
                "remove_name_from_products_table",
                "$this->expectedDirectory/remove_name_from_products_table.php"
            ],
        ];
    }
